        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
              <img src="{{asset('images/medi-logo.png')}}" height="80" alt="logo" loading="lazy" />
            </a>
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 fs-5">
              ...
              <li><a href="{{ route('about-us') }}" class="nav-link px-2 text-white">About Us</a></li>
              <li><a href="#" class="nav-link px-2 text-white">Appiontment</a></li>
            ...
            <div class="text-end mt-3">
              <button type="button" class="btn btn-primary me-2 fs-6" onclick="window.location='{{ route('login') }}'">Login</button>
            </div>
          </div>
        </div>
      </header>
    ...
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            <a href="#!">
              <img src="{{asset('images/medi-logo.png')}}" alt="BootstrapBrain Logo" height="175" width="auto">
            </a>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <address class="mb-4">Fulbarigate , kuet, Khulna</address>
            <p class="mb-1">
              <a class="link-secondary text-decoration-none" href="tel:+15057922430">+880 12367489</a>
            </p>
            <p class="mb-0">
              <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">rafi@gmail.com</a>
            </p>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <ul class="list-unstyled">
              ...
              <li class="mb-2">
                <a href="#!" class="link-secondary text-decoration-none">Appiontment</a>
              </li>
              <li class="mb-2">
      ...
      <div class="row gy-4 gy-md-0 align-items-md-center">
        <div class="col-xs-12 col-md-7 order-1 order-md-0">
          ...
          <div class="credits text-secondary text-center text-md-start mt-2 fs-8">
            Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">Rafi</a> with <span class="text-primary">&#9829;</span>
          </div>
        </div>
