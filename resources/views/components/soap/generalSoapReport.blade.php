<div class="text-center mb-4">
    <h1>General Soap notes Reports</h1>
</div>
<div class="container">
...
<script>
    $(document).ready(function(){
        $('#submitBtn').click(function(){
            ...
            $.ajax({
                url: '/generalSoapReportData', // Replace this with your server endpoint URL
                method: 'GET',
                data: { appointment_id: appointment_id },
                success: function(response){
                    // Display the fetched data
                    $('#displayGeneralData').html(response);
                },
